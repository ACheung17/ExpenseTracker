    ...
    render() { 
        return ( 
            <div>
                <AppNav />
                <Container>
                <h4>TRY IT OUT: CLICK <span><img className="button-img" src="/button.PNG" /></span> AT THE TOP RIGHT ↗</h4>
                    ...
                    <h4>The FRONT-END</h4>
                    <p>
                        React.js was chosen to be the framework to implement the front-end of the application, because
